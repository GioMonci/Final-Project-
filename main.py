...
__author__ = "Giovanni Moncibaez"

# Negotium Terminare Respublica (NTR) - business to terminate the republic

# NTR is a robot / program and character that I am creating for a rpg game I
# want to make in the future.

# NTR can do whatever the user wants it to do if it's within its ability.

# NTR hates humanity, but It's still programed to help any user.
